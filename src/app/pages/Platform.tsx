    ...
    <>
        ...
        <dl className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {PRINCIPLES.map((p, i) => (
            <Reveal as="div" key={p.k} delay={i * 0.05}>
              <div className="h-full rounded-[var(--radius)] border border-line bg-ground p-6">
      ...
      <Section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Reveal>
            <div className="h-full rounded-[var(--radius)] border border-line bg-surface p-7">
...
export function PlatformGRC() {
  return (
    <>
      ...
      <Section>
        <SectionHead eyebrow="Current state" title="The interface as it exists today." lead="Unfinished and real. The command centre with task queues and the asset-risk heat map, from the development build." />
        <Reveal>
          <div className="rounded-[var(--radius)] border border-line bg-surface elev overflow-hidden">
            <img src="/projects/grc.png" alt="Strativu GRC development build: command centre with expired, today and future task lists and an asset-risk heat map." className="w-full h-auto block" loading="lazy" />
          </div>
          <p className="mt-3 font-mono text-[11px] text-ink-3">Development build, September 2026. Visual design is being aligned to the platform system; data is illustrative.</p>
        </Reveal>
      </Section>
